...
- (void)viewDidLoad {
    ...
    [headerView loadComponentsWithTitle:_userNickName];
    ...
    self.chatToolbar = [[EaseChatToolbar alloc] initWithFrame:CGRectMake(0, screenHeight - chatbarHeight, self.view.frame.size.width, chatbarHeight) type:barType];
...
- (void)setChatToolbar:(EaseChatToolbar *)chatToolbar
{
    ...
    tableFrame.size.height = self.view.frame.size.height - _chatToolbar.frame.size.height-CGRectGetHeight(headerView.frame);
...
- (void)chatToolbarDidChangeFrameToHeight:(CGFloat)toHeight
{
    [UIView animateWithDuration:0.3 animations:^{
        ...
        rect.origin.y = CGRectGetMaxY(headerView.frame);
        rect.size.height = self.view.frame.size.height - toHeight-CGRectGetMaxY(headerView.frame);
