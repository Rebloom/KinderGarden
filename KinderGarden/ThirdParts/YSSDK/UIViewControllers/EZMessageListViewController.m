...
- (void)viewDidLoad {
    ...
    self.title = @"消息";
    [EZOpenSDK getUnreadMessageCount:_deviceSerial messageType:EZMessageTypeAlarm completion:^(NSInteger count, NSError *error) {
...
//        [EZOpenSDK getAlarmList:weakSelf.cameraId
...
//                     }];
        [EZOpenSDK getAlarmListBySerial:weakSelf.deviceSerial
                              pageIndex:weakSelf.currentIndex++
                               pageSize:EZMessageListPageSize
//                              beginTime:weakSelf.beginTime
//                                endTime:weakSelf.endTime
