...
- (void)checkDevice
{
    self.tipsLabel.text = @"请将设备插上电后等待大约30秒，直到设备启动完成";
    [self.nextButton setTitle:@"设备已启动好，且是第一次配置网络" forState:UIControlStateNormal];
    [self.exceptionButton setTitle:@"这台设备以前配过网络" forState:UIControlStateNormal];
