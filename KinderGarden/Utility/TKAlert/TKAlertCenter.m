...
#define kTagAlertViewFrame  CGRectMake(25, screenHeight/2-30, screenWidth-50, 60)
...
- (void)postAlertWithMessage:(NSString *)_message
{
    [self postAlertWithMessage:_message withType:ALERTTYPESUCCESS];
}
...
- (id) init
{
    ...
    backImage.backgroundColor = [UIColor darkGrayColor];
...
- (void)adjust
{
    self.bounds = CGRectMake(0, 0, screenWidth-50, 60);
    [self setNeedsLayout];
